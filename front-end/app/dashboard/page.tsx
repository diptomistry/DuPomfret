...
const features = [
  {
    ...
    description: "Upload and browse lecture slides, PDFs, code files, and references.",
  ...
  {
    title: "AI Search",
    description: "Ask questions in plain English and find relevant documents instantly.",
  ...
  {
    title: "AI Generator",
    description: "Create study notes, slide outlines, and code examples from your content.",
  ...
  {
    title: "Code Checker",
    description: "Validate code with syntax checks, tests, and helpful diagnostics.",
  ...
  {
    title: "AI Tutor",
    description: "Chat with an AI assistant that knows your course materials.",
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Jump into any feature to start learning smarter
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:gap-5 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 transition-opacity duration-300 group-hover:opacity-5 dark:group-hover:opacity-10`} />
                  
                  {/* Animated border glow */}
                  <div className={`absolute inset-0 rounded-xl bg-gradient-to-br ${feature.gradient} opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-20`} />
                  
                  <CardHeader className="relative pb-2 sm:pb-3">
                    <div className="flex items-start justify-between gap-2">
                      <div className={`rounded-xl bg-gradient-to-br ${feature.gradient} p-3 shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:shadow-xl`}>
                        <feature.icon className="size-5 text-white" />
                      </div>
                      <Badge variant={feature.badgeVariant} className="font-semibold text-xs">{feature.badge}</Badge>
                    </div>
                    <CardTitle className="relative mt-4 text-lg sm:text-xl font-bold">{feature.title}</CardTitle>
            ...
            <Card className="relative overflow-hidden border-2 border-dashed border-primary/30 bg-gradient-to-br from-amber-500/5 via-orange-500/5 to-yellow-500/5 dark:from-amber-500/10 dark:via-orange-500/10 dark:to-yellow-500/10">
              ...
              <CardContent className="relative flex flex-col sm:flex-row items-center gap-6 py-8 sm:py-10">
                ...
                <div className="text-center sm:text-left">
                  <h3 className="text-lg font-bold text-foreground mb-2">Pro Tip</h3>
                  <p className="text-sm sm:text-base text-muted-foreground max-w-lg leading-relaxed">
                    Start by uploading your course materials in <span className="font-semibold text-primary">Materials</span>, 
                    then use <span className="font-semibold text-primary">AI Search</span> and <span className="font-semibold text-primary">AI Tutor</span> to interact with your content using natural language.
                  </p>
                </div>
              </CardContent>
            </Card>
