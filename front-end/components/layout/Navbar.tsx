      ...
      <div className="flex h-16 sm:h-18 items-center justify-between px-4 sm:px-6 md:px-8 lg:px-10 max-w-screen-2xl mx-auto w-full">
        ...
        >
          ...
          <span className="hidden sm:flex flex-col">
            <span className="text-base sm:text-lg font-bold tracking-tight">AI Companion</span>
            <span className="text-[10px] sm:text-xs text-muted-foreground font-medium -mt-0.5">Course Assistant</span>
          </span>
        </Link>
        ...
        <nav className="flex items-center gap-2 sm:gap-3">
          ...
          {isAuthenticated ? (
            <>
              {!isDashboard && (
                <Button variant="ghost" asChild className="gap-2 h-9 sm:h-10 px-3 sm:px-4 text-sm">
            ...
            <Button asChild className="h-9 sm:h-10 px-4 sm:px-6 font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all">
